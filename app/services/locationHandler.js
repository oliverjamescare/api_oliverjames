...
module.exports = {
    ...
    getCustomLocation(req)
    {
        return new Promise((resolve, reject) => {
            ...
            const query = (req.body.company ? req.body.company + ", " : "") + req.body.address_line_1 + ", " + (req.body.address_line_2 ? req.body.address_line_2 + ", " : "") + req.body.city + ", " + req.body.postal_code;
